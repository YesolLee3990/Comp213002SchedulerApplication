    ...
    <form id="form1" runat="server">
        <div id="allpageDiv" style="width: auto; height: auto; margin: 10%;">
            ...
            <div id="detailDiv" style="width: auto; height: 450px;">
                ...
                <br />
                <asp:Label ID="labelSdate" runat="server" Text="Start Date : "></asp:Label><asp:TextBox ID="txtSdate" runat="server" Width="70%"></asp:TextBox>
                <br />
                <asp:Label ID="labelEdate" runat="server" Text="End Date : "></asp:Label>&nbsp<asp:TextBox ID="txtEdate" runat="server" Width="70%"></asp:TextBox>
